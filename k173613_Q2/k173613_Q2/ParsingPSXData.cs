...
namespace k173613_Q2
{
    class ParsingPSXData
    {
        ...
        private void _timer_Elapsed(object sender, ElapsedEventArgs e)
        {
            ...
            try
            {
                string check = File.ReadAllText(file_name);     // If File not Exist Catch Statement
            ...
            catch (Exception b)
            {
                ...
                File.AppendAllLines(log_file, new[] { logDT.ToString() + " : ParsingPSXData - Error Occured due to File Not Found...!" });
            }
